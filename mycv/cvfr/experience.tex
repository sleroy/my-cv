...
\cventry
{Software Quality Manager Senior} % Job title
{AZQORE SA/Credit Agricole} % Organization
{Lausanne, Suisse} % Location
{Décembre 2017 - Aout 2018} % Date(s)
{
    \begin{cvitems} % Description(s) of tasks/responsibilities
...
\cventry
{Architecte de Solution, Tech Lead} % Job title
{SERIAL SA} % Organization
{Genève, Suisse} % Location
