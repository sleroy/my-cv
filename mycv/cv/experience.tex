...
\begin{cventries}
    ...
    {January 2023 - Present} % Date(s)
    {
		...
		\item {Delivered two Twitch sessions, two public recorded videos, participated to 4 summits, delivered 3 public talks, 3 Hackatons/EBA}
        \item {70\% Activity on pre-sales, 20\% existing AWS customers; 10\% internal enablements}
               \end{cvitems}
            }
            {
