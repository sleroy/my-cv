...
<<<<<<< HEAD
    %---------------------------------------------------------
    \cventry
    {Specialist Solution Architect in Migration and Modernization} % Job title
    ...
    {Septembre. 2021 - Dec. 2022} % Date(s)
    {
        ...
        {September 2017 - September 2021} % Date(s)
        {}
    ...
    \end{cvitems}
        }
        {
            \begin{cvitems}
                ...
                \subitem{SCA: Source code analyzers for mainframe technologies}
                \subitem{Workbench: Eclipse / VSCode IDE for Mainframe programmers with a full set of features}
                \subitem{Workbench Server: remote compilation / execution for Cobol/PLI programs}
