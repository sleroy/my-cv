...
%---------------------------------------------------------
\cventry {How to build your business case for a Cloud migration ? } % Role
{AWS Innovate 2023} % Event
{Worldwide} % Location
{2023} % Date(s)
{
...
\cventry {AWS and SAP : how to migrate ? } % Role
{AWS + Techfirm conference} % Event
...
{2023} % Date(s)
{
	...
	\cventry {Key speaker for the ScaleUp 360 Legacy IT Europe Conference } % Role
{Byoskill} % Event
